# grunt-usemin - PATCHED VERSION for planfredwebsite!

## Patch Info:

Added lib/jsprocessor.js to process angularjs precompiled JavaScript templates for img-Tag srcfile attributes and replace the srcfile content with rev file links
